...
namespace Sopdu.ProcessApps.main
{
    public class MainApp : GenericDevice
    {
        ...
        private UsbCamera _InputStackerCamera;
        [XmlIgnore]
        public UsbCamera InputStackerCamera { get { return _InputStackerCamera; } set { _InputStackerCamera = value; NotifyPropertyChanged("InputStackerCamera"); } }
        ...
        {                      
            ...
            InputStackerCamera = UsbCamera.loadFile(@".\IPCamera.xml");
            InputStackerCamera.Init();
...
//*** secs gem init
            ...
            ipstacker.usbCamera = InputStackerCamera;
        ...
        {
            //throw new NotImplementedException();
            this.InputStackerCamera.CarrierTrayDisplay = DispStack;
        }
